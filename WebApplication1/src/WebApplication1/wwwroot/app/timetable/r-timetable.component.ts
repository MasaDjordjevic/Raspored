...
export class TimetableComponent {
    ...
    public classes = [
        [
            // ponedeljak
            {startMinutes: 500, durationMinutes: 60, activityTitle: "Teretana", activityContent: "Moji su bicepsi biseri rasuti po celom benču", color: "#E91E63", active: true},
            {startMinutes: 615, durationMinutes: 45, className: "Sistemi baza podataka", abbr: "SBP", classroom: "A2", assistant: "Vlada Mihajlovitj", type: "predavanje", color: "#f44336", active: true},
