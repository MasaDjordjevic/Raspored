                    ...
                    if (this.routes === null) {
                        this.routes = [
                            ...
                            new router_1.AsyncRoute({
                                path: "/test",
                                name: "Test",
                                loader: function () { return System.import("app/components/test.component").then(function (c) { return c["TestComponent"]; }); }
                            }),
                            new router_1.AsyncRoute({
                                path: "/roles",
                                name: "Roles",
                                loader: function () { return System.import("app/components/roles.component").then(function (c) { return c["RolesComponent"]; }); }
                            }),
                        ];
